...
<div id="demo" class="row">
    ...
    <div class="col-sm-1" id="vertical_tab_nav">
        <ul>
            ...
            <li class="selected"><a href="registered_courses">Registered courses</a></li>
            <li class="selected"><a href="register_courses">Register courses</a></li>
        ...
        <div class="table" >
            ...
            <div class="table-responsive-vertical shadow-z-1" style="margin-top: 40px; width: 96%;overflow-x:auto; margin-left: 20px; font-family:Courier New; font-size: 12px">
                <table id="table" class="table table-hover table-mc-light-blue table-responsive" >
                    ...
                    //  echo $course;
                    $course_student=Course_user::where('user_id',$_SESSION['id'])->where('course_id',$course->id)->first();

                    ?>
                    <tr>
                        <td data-title="Date">{{$course->name}}</td>
                        <td data-title="ID" >{{$course->user->fname." ".$course->user->lname}}</td>
                        <td data-title="ID" >{{$course_student->grade}}</td>


                        <td data-title="Edit">   <a href="registered_courses/{{$course->id}}"><i class="fa fa-edit" style="padding-left: 5px"></i>Drop</a></td>
