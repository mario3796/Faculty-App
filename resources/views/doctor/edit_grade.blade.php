...
<div class=" col-sm-9">
    ...
    <form method="post" action="/student_courses/edit/{{$course_student->course->id}}/{{$course_student->user->id}}">
    {{csrf_field()}}        <!--  General -->
        <div class="form-group">
            <h2 class="heading">edit {{$course_student->user->fname." ".$course_student->user->lname}} grade </h2>


            <div class="grid">
                <div class="col-1-2 col-1-2-sm ">
                    <div class="controls">
                        <input type="text" value="{{$course_student->grade}}" name="grade" class="floatLabel" id="first-name" placeholder="enter first name">
