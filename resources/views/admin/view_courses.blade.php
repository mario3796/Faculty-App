...
<div id="demo" class="row">
    ...
    <div class="col-sm-11" >
        <div class="table" >
            ...
            <a href="add_course" style="color: #000"><i class="fa fa-plus" style="padding-right:  10px"></i>Create New</a>
            ...
            <div class="table-responsive-vertical shadow-z-1" style="margin-top: 40px; width: 96%;overflow-x:auto; margin-left: 20px; font-family:Courier New; font-size: 12px">
                ...
                <table id="table" class="table table-hover table-mc-light-blue table-responsive" >
                    ...
                    <tr class="line">
                        <th>ID</th>
                        <th>name</th>
                        <th style="width: 80px">doctor name</th>
                        <th>level</th>
                    ...
                    <tr>
                        ...
                        <td data-title="Date">{{$course->name}}</td>
                        <td data-title="ID" >{{$course->user->fname." ".$course->user->lname}}</td>

                        <td data-title="DueBy">{{$course->level}}</td>

                        <td data-title="Edit">   <a href="edit_course/{{$course->id}}"><i class="fa fa-edit" style="padding-left: 5px"></i>Edit</a></td>
                        <td  data-title="Details"><a href="details/{{$course->id}}" class=" w3-small "> <i class="fa fa-info-circle" style="padding-left: 0px"></i>Details</a> </td>
                        <td data-title="Delete">   <a href="add_course/{{$course->id}}"><i class="fa fa-trash-o" style="padding-left: 0px"></i>Delete</a></td>
                    </tr>
                    <?php
