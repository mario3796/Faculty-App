...
<div id="demo" class="row">
    ...
    <div class="col-sm-11" >
        <div class="table" >
            ...
            <a href="add_doctor" style="color: #000"><i class="fa fa-plus" style="padding-right:  10px"></i>Create New</a>
            ...
            <div class="table-responsive-vertical shadow-z-1" style="margin-top: 40px; width: 96%;overflow-x:auto; margin-left: 20px; font-family:Courier New; font-size: 12px">
                ...
                <table id="table" class="table table-hover table-mc-light-blue table-responsive" >
                    ...
                    <tr>
                        ...
                        <td data-title="Date">{{$doctor->fname." ".$doctor->lname}}</td>
                        <td data-title="ID" >{{$doctor->email}}</td>

                        <td data-title="DueBy">{{$doctor->birth_date}}</td>

                        <td data-title="Edit">   <a href="edit_doctor/{{$doctor->id}}"><i class="fa fa-edit" style="padding-left: 5px"></i>Edit</a></td>
                        <td  data-title="Details"><a href="details/{{$doctor->id}}" class=" w3-small "> <i class="fa fa-info-circle" style="padding-left: 0px"></i>Details</a> </td>
                        <td data-title="Delete">   <a href="add/{{$doctor->id}}"><i class="fa fa-trash-o" style="padding-left: 0px"></i>Delete</a></td>
                    </tr>
                    <?php
                    }}
                    ?>
